today = '오늘은 목요일입니다. 코로나검사해야 합니다.'
print(today.find('독감')) #-1: 없음
print(today.find('니다')) #12: 시작 인덱스
...
# index = -1
# while True:
#     index = news.find(target, index + 1)
#     if index == -1:
#         break
#     print('start=%d' % index)
